...
class FlowXExtractor:
    ...
    def _spectral_group(
        W: np.ndarray,
        lam: float = 0.0, # group size control parameter: higher lam means smaller groups
    ...
    def find_group_from_hotspot_hour(
        ...
        *,
        ...
        group_size_lam: float = 0.0,  # spectral relaxation parameter, required if average_objective is False
        normalize_by_degree: bool = False,
        average_objective: bool = True, 
    ...
    def find_groups_from_hotspot_hour(
        ...
        *,
        ...
        group_size_lam: float = 0.0, # group size control parameter: higher lam means smaller groups
        normalize_by_degree: bool = False,
        average_objective: bool = True,
        k_max_trajectories_per_group: Optional[int] = None,
        max_groups: int = 3,
        ...
        path_length_gamma: float = 0.0, # higher gamma prefers longer paths
        debug_verbose_path: Optional[str] = None,
    ) -> List[Dict[str, Any]]:
        """
